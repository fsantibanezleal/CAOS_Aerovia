...
The content convention for this product: no emojis and no em-dashes in repo content. Both read as
...
What it flags (precise, to avoid punishing legitimate glyphs):
  ...
  - EMOJI: any codepoint in the Supplementary emoji/pictograph planes U+1F000..U+1FAFF, plus the
    ...
    the middot U+00B7, arrows like U+2197, check/cross marks, stars.
